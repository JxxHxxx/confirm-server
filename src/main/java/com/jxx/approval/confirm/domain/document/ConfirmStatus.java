...
public enum ConfirmStatus {
    ...
    protected static final List<ConfirmStatus> cancelPossible = List.of(CREATE, UPDATE);
    ...
    public static final List<ConfirmStatus> REJECT_POSSIBLE_STATUS = List.of(RAISE);
    public static final List<ConfirmStatus> ACCEPT_POSSIBLE_STATUS = List.of(RAISE);
